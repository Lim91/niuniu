      ...
      tabbarData: [
        {
          ...
          inactiveImg: require("../assets/images/drink.png"),
          activeImg: require("../assets/images/drink_active.png"),
        },
        {
          title: "菜单",
          icon: "search",
        ...
        },
        {
          ...
          name: "Shopbag",
          path: "/main/shopbag",
          inactiveImg: require("../assets/images/shopcar.png"),
          activeImg: require("../assets/images/shopcar_active.png"),
        },
        {
          title: "我的",
          icon: "setting-o",
