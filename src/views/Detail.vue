  ...
  <div class="detail">
        ...
        <div class="pro-info">
          <div class="clearfix pro-box">
            ...
            <div class="fr pro-price">
              ￥{{ productDetail.price * product.count }}
            </div>
          </div>
    ...
    <van-goods-action>
      <van-goods-action-icon
        ...
        :color="bagCount > 0 ? '#6754d1' : '#646566'"
      />
      <van-goods-action-icon
        icon="like"
        :text="isLike ? '已收藏' : '未收藏'"
      ...
      <van-goods-action-button
        ...
        @click="addShopbag"
      />
      <van-goods-action-button text="立即购买" color="#6754d1" @click="goPay" />
    </van-goods-action>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    goPay() {
      ...
      this.addShopbag();
      setTimeout(() => {
        this.$router.push({ name: "Pay", query: { sids: this.sid } });
      }, 1000);
    },
  },
};
